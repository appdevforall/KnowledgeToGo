...
public class EnvironmentProcessMatcherTest {
    ...
    private static final String ROOTFS = "/data/user/0/org.iiab.controller/files/rootfs/installed-rootfs/iiab";

    /** What /proc shows for the long-running environment, argv joined with spaces. */
    private static String environmentCmdline() {
        return "/data/app/org.iiab.controller/lib/arm64/libproot.so --sysvipc -0 --link2symlink"
    ...
    public void anInstallRunroleAgainstTheSameRootfsIsNotTheEnvironment() {
        ...
        String runrole = "/data/app/org.iiab.controller/lib/arm64/libproot.so --kill-on-exit -r "
    ...
    public void aBackupOrCloneProotIsNotTheEnvironmentEither() {
        String backup = "/data/app/org.iiab.controller/lib/arm64/libproot.so -r " + ROOTFS
