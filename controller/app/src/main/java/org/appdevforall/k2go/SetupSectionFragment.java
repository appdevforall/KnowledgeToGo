...
import org.appdevforall.k2go.applang.domain.LocaleMatcher;
...
public class SetupSectionFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        org.appdevforall.k2go.help.TooltipWiring.wireAll(v);
    ...
    private void maybeShowAnalyticsEnrollment() {
        ...
        new BrandDialog(requireContext())
                ...
                .setPositive(R.string.analytics_enroll_accept, () -> {
                    ...
                    org.appdevforall.k2go.analytics.AnalyticsClient.with(requireContext()).applyConsent();
    ...
    private void completeSetup() {
        ...
        org.appdevforall.k2go.analytics.AnalyticsClient.with(requireContext()).logOnboardingCompleted();
        ...
        startActivity(new Intent(requireContext(), org.appdevforall.k2go.redesign.LibraryActivity.class));
    ...
    private void setupListeners() {
        ...
        switchStorage.setOnClickListener(v -> {
            ...
            if (switchStorage.isChecked()) {
                org.appdevforall.k2go.permissions.StoragePermission.request(
    ...
    private boolean hasStoragePermission() {
        return org.appdevforall.k2go.permissions.StoragePermission.isGranted(requireContext());
    }
