...
public final class KolibriProvisioner {
     ...
     *
     * <p>The rule itself moved to {@link org.appdevforall.k2go.system.data.ContentAdmission}: Books
    ...
    static boolean canDrainNow(Context ctx) {
        return org.appdevforall.k2go.system.data.ContentAdmission.canStart(ctx, org.appdevforall.k2go.system.domain.ContentType.COURSES);
    }
