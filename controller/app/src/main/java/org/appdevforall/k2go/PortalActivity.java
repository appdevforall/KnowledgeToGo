...
import org.appdevforall.k2go.portal.presentation.PortalViewModel;
...
public class PortalActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        AppExecutors.get().io().execute(() -> {
            final String v = org.appdevforall.k2go.redesign.DashboardVersion.installed(this);
            if (v == null || v.isEmpty()
                    || v.equals(org.appdevforall.k2go.redesign.UpdateStatusCache.cacheClearedVersion(this))) {
                return;
            }
            runOnUiThread(() -> {
                if (webView == null) return;
                webView.clearCache(true);
                org.appdevforall.k2go.redesign.UpdateStatusCache.setCacheClearedVersion(this, v);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.clearCache(true);
        org.appdevforall.k2go.redesign.UpdateStatusCache.setCacheClearedVersion(
                this, org.appdevforall.k2go.redesign.DashboardVersion.installed(this));
        ...
        fqr = new org.appdevforall.k2go.redesign.FqrController(this, webView);
    ...
    private void autoLoginThenLoad(String service, String targetUrl) {
        ...
        org.appdevforall.k2go.redesign.AuthClient.session(service, consumerUa, new org.appdevforall.k2go.redesign.AuthClient.SessionCb() {
