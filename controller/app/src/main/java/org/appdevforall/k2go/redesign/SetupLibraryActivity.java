 ...
 */
public class SetupLibraryActivity extends AppCompatActivity implements org.appdevforall.k2go.ServerController.Host {
    ...
    private org.appdevforall.k2go.wizard.presentation.WizardSelectionViewModel selection;
    ...
    private org.appdevforall.k2go.wizard.presentation.WizardSelectionViewModel selection() {
        if (selection == null) {
            selection = new androidx.lifecycle.ViewModelProvider(this,
                    new org.appdevforall.k2go.wizard.presentation.WizardSelectionViewModelFactory(this, this))
                    .get(org.appdevforall.k2go.wizard.presentation.WizardSelectionViewModel.class);
        }
        return selection;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (brJobMode != null) {
                ...
                org.appdevforall.k2go.system.data.PendingWork.clearAll(this);
    ...
    public void openContentType(String key, String title) {
        ...
        // tree need no server, so it works identically here. Only the forward action differs.
            ...
            f = new org.appdevforall.k2go.kolibri.presentation.KolibriBrowseFragment();
    ...
    public void openKolibriWizard() {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.k2go_setup_host,
                        new org.appdevforall.k2go.kolibri.presentation.KolibriBrowseFragment())
    ...
    public void openKolibriTopics(String channelId) {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.k2go_setup_host,
                        org.appdevforall.k2go.kolibri.presentation.KolibriTopicsFragment
    ...
    public void openKolibriConfirm() {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.k2go_setup_host,
                        new org.appdevforall.k2go.kolibri.presentation.KolibriConfirmFragment())
    ...
    public org.appdevforall.k2go.ServerController server() { return serverController; }
