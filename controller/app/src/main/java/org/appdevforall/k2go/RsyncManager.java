...
import org.appdevforall.k2go.sync.domain.RsyncConfig;
import org.appdevforall.k2go.sync.domain.RsyncOutcome;
import org.appdevforall.k2go.sync.domain.RsyncProgress;
import org.appdevforall.k2go.sync.domain.RsyncProcessMatcher;
import org.appdevforall.k2go.sync.domain.ShareConfig;
import org.appdevforall.k2go.sync.domain.SyncCredentialValidator;
import org.appdevforall.k2go.sync.transport.SecretStore;
            ...
            rsyncBinPath = rsyncBin.getAbsolutePath();
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    // so the failure report a user can send carries them.
                        ...
                        org.appdevforall.k2go.LogRepository.get().append("[Rsync] " + line);
