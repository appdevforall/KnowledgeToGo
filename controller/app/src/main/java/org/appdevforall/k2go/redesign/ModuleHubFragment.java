...
public class ModuleHubFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle s) {
        ...
        org.appdevforall.k2go.install.presentation.ModuleQueueRepository.get().state()
    ...
    private void probeAll() {
        ...
        AppExecutors.get().io().execute(() -> {
            ...
            final boolean present =
                    org.appdevforall.k2go.SystemStateEvaluator.isSystemInstalled(appCtx);
    ...
    private void buildCards() {
        ...
        switch (org.appdevforall.k2go.system.data.SystemFactsReader.verdict(requireContext())) {
            case INSTALLING:
            ...
            case CLONE_SHARING: {
                ...
                String mod = org.appdevforall.k2go.install.presentation.ModuleQueueRepository.get().currentModule();
    ...
    private View cardRow(final ModuleCards.Card c, final boolean isInstalled,
        ...
        final boolean failed = !isInstalled
                && org.appdevforall.k2go.install.presentation.ModuleQueueRepository.get().current().didFail(c.key());
        LinearLayout row = new LinearLayout(requireContext());
        row.setOrientation(LinearLayout.HORIZONTAL);
        row.setGravity(Gravity.CENTER_VERTICAL);
        row.setBackgroundResource(R.drawable.k2go_card_bg);
