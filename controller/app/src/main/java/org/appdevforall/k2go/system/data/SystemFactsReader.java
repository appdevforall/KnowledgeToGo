...
import org.appdevforall.k2go.system.domain.SystemPresence;
...
public final class SystemFactsReader {
     ...
     * the pure {@link org.appdevforall.k2go.system.domain.SystemVerdict}. Does NOT feed the boot gate,
     * the server-start gate or the recovery dialog — those keep their strict checks.
     */
    public static org.appdevforall.k2go.system.domain.SystemVerdict.State verdict(Context ctx) {
        if (ctx == null) {
            return org.appdevforall.k2go.system.domain.SystemVerdict.State.NO_SYSTEM;
        }
        ServerStateRepository server = ServerStateRepository.get();
        return org.appdevforall.k2go.system.domain.SystemVerdict.evaluate(
                ...
                org.appdevforall.k2go.redesign.CloneSendSession.isActive(),
