...
public class ServerController {
    ...
    private volatile org.appdevforall.k2go.env.domain.ServerLiveness lastLiveness;
    ...
    public void createFakeSysData(File rootfsDir) {
        ...
        org.appdevforall.k2go.env.EnvironmentControl.createFakeSysData(rootfsDir);
    }
    ...
    public void startEnvironment() {
        ...
        AppExecutors.get().io().execute(() -> {
            ...
            boolean envAlive = org.appdevforall.k2go.env.EnvironmentProcess.isRunning(activity);
            ...
            boolean servicesAlive = org.appdevforall.k2go.redesign.RestReadiness.apiReady();
            ...
            org.appdevforall.k2go.env.domain.ServerLiveness ll = lastLiveness;
            long servicesDownMs = (ll == null) ? -1L
                    : ll.servicesDownMs(now, org.appdevforall.k2go.env.domain.ServerLiveness.DEFAULT_FRESH_MS);
            ...
            long silentMs = org.appdevforall.k2go.env.EnvironmentProgress.silentMs(now);
            org.appdevforall.k2go.env.domain.EnvironmentEnsure.Action action =
                    org.appdevforall.k2go.env.domain.EnvironmentEnsure.decide(
            ...
            switch (action) {
                ...
                case KILL_AND_RELAUNCH:
                    ...
                    org.appdevforall.k2go.env.EnvironmentProcess.killOrphan(activity);
                    activity.runOnUiThread(this::doLaunchEnvironment);
                    break;
                case NOOP_HEALTHY:
    ...
    private void doLaunchEnvironment() {
        ...
        org.appdevforall.k2go.env.EnvironmentProgress.launched();   // ADFA-5365: first sign of life
        ...
        serverEngine.executeInContainer(activity, rootfsDir.getAbsolutePath(), startCmd, new PRootEngine.OutputListener() {
            ...
            public void onOutputLine(String line) {
                ...
                org.appdevforall.k2go.env.EnvironmentProgress.alive();
