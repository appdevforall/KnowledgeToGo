 ...
 * ============================================================================
 */
package org.appdevforall.k2go.deploy.data;

import android.content.Context;
import android.util.Log;

import org.appdevforall.k2go.deploy.domain.ElfClass;
import org.appdevforall.k2go.deploy.domain.RootfsArchive;
...
public final class RootfsArchiveValidator {
     ...
     * {@link org.appdevforall.k2go.deploy.domain.RootfsIdentity}, which is where the decision lives
    ...
    public static Result identityRejection(RootfsManifest.Identity id) {
        org.appdevforall.k2go.deploy.domain.RootfsIdentity.Verdict v =
                org.appdevforall.k2go.deploy.domain.RootfsIdentity.check(
                        id != null && id.present,
    ...
    public static String rejectionMessage(Context ctx, Result r) {
        if (r == Result.NOT_A_ROOTFS) return ctx.getString(org.appdevforall.k2go.R.string.install_error_not_rootfs);
        if (r == Result.WRONG_ARCH) return ctx.getString(org.appdevforall.k2go.R.string.install_error_wrong_arch);
        if (r == Result.CORRUPT) return ctx.getString(org.appdevforall.k2go.R.string.install_error_corrupt);
        return null;
    }
