...
public class QrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        org.appdevforall.k2go.help.TooltipWiring.wireAll(getWindow().getDecorView()); // Rename your dialog_qr.xml to this
    ...
    private void fetchNetworkInterfaces() {
        ...
        org.appdevforall.k2go.sync.transport.NetworkInterfaces.LanIps ips = org.appdevforall.k2go.sync.transport.NetworkInterfaces.discover();
        wifiIp = ips.wifiIp;
    ...
    private Bitmap generateQrCode(String text) {
        ...
        return org.appdevforall.k2go.sync.transport.QrCodec.encode(text, 800);
    }
}
