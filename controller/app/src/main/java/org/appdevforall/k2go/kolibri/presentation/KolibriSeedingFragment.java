...
import org.appdevforall.k2go.redesign.ProvisioningChecklist;
...
public final class KolibriSeedingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        org.appdevforall.k2go.util.ProgressVisuals.apply(
                v, org.appdevforall.k2go.system.domain.ContentType.COURSES);   // ADFA-5074
